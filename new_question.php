...
if($_POST['MCQuestion']){
    ...
    if($_FILES['userfile']['name']>1){
        ...
        $Question->add_question($_POST['event'],$input,$_POST['option1'],$_POST['option2'],$_POST['option3'],$_POST['option4'],$_POST['option5'],$_POST['correct_answer'],null,1,$user->data['username_clean'],$user->data['user_id']);
        Echo 'Question Added';
    }
}
$Display = new Display;
